...
$logDst = "C:\NextgenId\CCAgent192\Logs"
if (Test-Path $logSrc) {
...
$destinationFile = "C:\NextgenId\CCAgent192\appsettings.json"
$licenseSource = "C:\NextgenId\CCAgent\license.lic"
$licenseDestination = "C:\NextgenId\CCAgent192\license.lic"
$serviceName = "NextgenIdCCAgent"
$newPath = "C:\NextgenId\CCAgent192\StationManagementService.exe"
...
$Path = "C:\NextgenId\CCAgent192\appsettings.json"  
